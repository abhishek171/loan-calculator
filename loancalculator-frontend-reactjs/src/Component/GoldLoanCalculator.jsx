...
const GoldLoanCalculator = () => {
  ...
  return (
    ...
    <Box sx={{ width: 250 }}>
      ...
      <Typography sx={{ display: 'flex', alignItems: 'center', gap: '99px', width: '120%' }} id="loan-amount" gutterBottom>
        Loan Amount <div style={{ border: '1px solid lightgrey', padding: '5px' }}>Rs. {loanAmount}</div>
      </Typography>
      <Slider
        sx={{ width: '120%' }}
        value={loanAmount}
      ...
      <Typography id="interest-rate" gutterBottom sx={{ display: 'flex', alignItems: 'center', gap: '150px',width: '120%' }}>
        Interest Rate <div style={{ border: '1px solid lightgrey', padding: '3px' }}>{interestRate} %</div>
      </Typography>
      <Slider
        sx={{ width: '120%' }}
        value={interestRate}
      ...
      <Typography id="loan-term" gutterBottom sx={{ display: 'flex', alignItems: 'center', gap: '150px',width: '120%' }}>
        Loan Term <div style={{ border: '1px solid lightgrey', padding: '3px' }}>{loanTerm} years</div>
      </Typography>
      <Slider
        sx={{ width: '120%' }}
        value={loanTerm}
